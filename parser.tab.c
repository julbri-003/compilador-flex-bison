...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MAS = 14,                       /* MAS  */
  YYSYMBOL_GUION = 15,                     /* GUION  */
  YYSYMBOL_ASIGNACION = 16,                /* ASIGNACION  */
  YYSYMBOL_CADENA = 17,                    /* CADENA  */
  YYSYMBOL_YYACCEPT = 18,                  /* $accept  */
  YYSYMBOL_programa = 19,                  /* programa  */
  YYSYMBOL_sentencias = 20,                /* sentencias  */
  YYSYMBOL_sentencia = 21,                 /* sentencia  */
  YYSYMBOL_asignacion = 22,                /* asignacion  */
  YYSYMBOL_instruccion_condicional = 23,   /* instruccion_condicional  */
  YYSYMBOL_24_1 = 24,                      /* $@1  */
  YYSYMBOL_resto_condicionales = 25,       /* resto_condicionales  */
  YYSYMBOL_bloque_condicionales = 26,      /* bloque_condicionales  */
  YYSYMBOL_bloque_condicional_else = 27,   /* bloque_condicional_else  */
  YYSYMBOL_expresion_comparacion = 28,     /* expresion_comparacion  */
...
{
       0,    40,    40,    44,    45,    49,    53,    54,    55,    56,
      60,    73,    73,    85,    87,    88,    93,   104,   115,   120,
     125,   134,   136
};
#endif
...
{
       3,    -1,    15,     4,     5,     8,    -3,   -21,    10,   -21,
      13,    11,    -4,   -21,    12,    14,    16,   -21,   -21,   -21,
      16,   -21,    16,    16,    16,    17,   -21,   -21,   -21,    18,
      20,    18,    18,    18,   -21,    24,    19,    22,    23,     6,
      25,   -21,    26,    16,   -21,   -21,    27,    29,   -21,    24,
      22,   -21
};
...
{
       0,    11,     0,     0,     0,    21,    11,     3,     0,     8,
       0,     0,     0,     1,     0,     0,     0,     2,     4,     6,
       0,     7,     0,     0,     0,     0,     5,     9,    21,    10,
       0,    18,    19,    20,    22,     0,     0,    13,     0,     0,
       0,    16,     0,     0,    15,    12,     0,     0,    17,     0,
      13,    14
};
...
{
      30,    17,     3,     4,     3,     4,     1,    22,    23,    24,
      25,    29,    42,    43,     5,    13,     5,    31,    32,    33,
      20,    14,    15,    47,    16,    19,    21,    26,    35,    27,
      36,    39,    25,    28,    34,    45,    38,    49,    41,    18,
      51,    50,    48,    46
};

static const yytype_int8 yycheck[] =
{
      20,     4,     5,     6,     5,     6,     3,    11,    12,    13,
      14,    16,     6,     7,    17,     0,    17,    22,    23,    24,
       7,    17,    17,    43,    16,    15,    15,    15,     8,    15,
       6,     9,    14,    17,    17,    10,    17,     8,    15,     6,
      50,    49,    15,    17
};
...
{
       0,     3,    19,     5,     6,    17,    20,    21,    22,    23,
      24,    28,    29,     0,    17,    17,    16,     4,    21,    15,
       7,    15,    11,    12,    13,    14,    15,    15,    17,    29,
      28,    29,    29,    29,    17,     8,     6,    26,    17,     9,
      25,    15,     6,     7,    27,    10,    17,    28,    15,     8,
      26,    25
};
...
#line 1141 "parser.tab.c"
  ...
  case 10: /* asignacion: CADENA ASIGNACION expresion  */
#line 61 "parser.y"
      {
          
          strncpy(variable, (yyvsp[-2].str), sizeof(variable)-1);
          variable[sizeof(variable)-1] = '\0';
          strncpy(valor_variable, (yyvsp[0].str), sizeof(valor_variable)-1);
...
#line 1194 "parser.tab.c"
  ...
  case 18: /* expresion_comparacion: expresion MAYOR expresion  */
#line 116 "parser.y"
      {
          condicion_verdadera = (comparar_cadenas((yyvsp[-2].str), (yyvsp[0].str)) > 0);
          //("Comparo '%s' > '%s' => %d\n", $1, $3, condicion_verdadera);
      }
#line 1203 "parser.tab.c"
    break;

  case 19: /* expresion_comparacion: expresion MENOR expresion  */
#line 121 "parser.y"
      {
          condicion_verdadera = (comparar_cadenas((yyvsp[-2].str), (yyvsp[0].str)) < 0);
          //("Comparo '%s' < '%s' => %d\n", $1, $3, condicion_verdadera);
...
#line 1212 "parser.tab.c"
  ...
  case 20: /* expresion_comparacion: expresion COMPARADOR expresion  */
#line 126 "parser.y"
      {
          condicion_verdadera = (strcmp((yyvsp[-2].str), (yyvsp[0].str)) == 0);
          //("Comparo '%s' == '%s' => %d\n", $1, $3, condicion_verdadera);
      }
...
#line 1227 "parser.tab.c"
  ...
  case 22: /* expresion: expresion MAS CADENA  */
#line 137 "parser.y"
    {
